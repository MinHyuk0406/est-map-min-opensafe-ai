...
const DEFAULT_SOURCES = [
  { category: '일반음식점', inputPath: path.join(__dirname, '../src/data/서울시 일반음식점 인허가 정보.csv') },
  { category: '휴게음식점', inputPath: path.join(__dirname, '../src/data/서울시 휴게음식점 인허가 정보.csv') },
  { category: '미용업', inputPath: path.join(__dirname, '../src/data/서울시 미용업 인허가 정보.csv') },
]
